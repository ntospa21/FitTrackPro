...
extension CustomErrorPatterns on CustomError {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String code, String message, String plugin)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CustomError() when $default != null:
        return $default(_that.code, _that.message, _that.plugin);
      case _:
        return orElse();
    }
  }
...
class _CustomError with DiagnosticableTreeMixin implements CustomError {
  _CustomError({this.code = '', this.message = '', this.plugin = ''});
